...
* We can also highlight multiple lines of code and clicke <kbd>Run</kbd>
...
It opens the help documentation in the **Help** tab in the bottom right RStudioe pane. It contains a description, usage, arguements and at the bottom, examples, for the function.  We see the first argument of `read_csv()` is a **file** meaning `read_csv()` needs the file location so it can read the file into R. With this information let's read write our `read_csv()` function so it knows where our arrrests data is. Remember from ealier, the arrests data is in the `data/` folder in our project. 
...
Look at the output in the console. It gives us some important information about our dataframe. 
...
This has been helpful, but the problem is we want to do more with our data than outputing  it to the console. In order to save our data and work on it, we need to make it into an object in R. Let's do this now by typing the following and running it:
...
[]:#lets use a package called DataExplorer 
[]:#library(DataExplorer)
[]:#create_report(arrests)
[]:#that's a 10,000 foot view of the data, now we can do other plot of specific variables 
[]:#What would you like to see? 
[]:# ggplot2 - let's create a custom graph
[]:#ask a question and try to answer with a graph

[]:# challenge - ok now you 
[]:#make arrest data spatial object 
[]:# #assignment - come up with R script has fill in the blanks challenges 
[]:# mostly graphing in ggplot 
