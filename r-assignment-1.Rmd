...
Complete the follow R coding challenges in RStudio Cloud Project <https://rstudio.cloud/spaces/31925/project/707259> in the `r-assignment-1.R` file. Save this file as you work.vYou will have until **11/19** by 5pm. If you encounter any problems, please come to
...
```{r ggplot-8-questions, eval=FALSE}
library(ggplot2)
